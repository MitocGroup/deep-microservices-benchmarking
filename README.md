![Digital Enterprise End-to-end Platform Microservices](https://github.com/MitocGroup/deep-microservices-helloworld/blob/master/src/DeepHelloWorld/Frontend/img/logo.png) DEEP Benchmarking 
===============
...
`DEEP Benchmarking` can be used by executing the following 4 simple steps in command line:
...
3. Using deepify, run locally the helloworld example:
  ...
  `deepify server ~/deep-benchmarking -o`
...
[Running Microservices in Development](https://github.com/MitocGroup/deep-microservices-benchmarking/blob/master/README.md#running-microservices-in-development).

4. Using deepify, deploy to AWS the helloworld example:

  `deepify deploy ~/deep-benchmarking`
...
[Running Microservices in Production](https://github.com/MitocGroup/deep-microservices-benchmarking/blob/master/README.md#running-microservices-in-production).
...
See Step 3 in 
[Getting Started](https://github.com/MitocGroup/deep-microservices-benchmarking/blob/master/README.md#getting-started)
...
```
DeepBenchmarking/       --> root folder of the DeepBenchmarking microservice
  ...
  Backend/              --> this folder includes everything back-end related
    ...
    src/                --> this folder includes all files used by back-end
      CaseWithBabel/    --> this folder includes the code (with babel use case) loaded into Lambda
  ...
  Models/               --> this folder includes everything models related
    Name.json           --> this file is an example of the Name's model definition
    ...
...
Our goal is to support two kinds of testing in the deep-microservice-benchmarking: Unit tests and End to End tests.
...
- [github issues](https://github.com/MitocGroup/deep-microservices-benchmarking/issues)
...
> See [CHANGELOG.md](https://github.com/MitocGroup/deep-microservices-benchmarking/blob/master/CHANGELOG.md) for latest changelog.
